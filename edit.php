...
<head>
   ...
   <!--kapag tinanggal ko ito nagiging katulad ng UI ko sa users
                        ...
                        <tr>
                            ...
                            <td>
                                <i style="cursor:pointer;"
                                    class="bx bxs-edit"  
                                    onclick="openForm('<?php echo $row['service_id']; ?>', '<?php echo addslashes($row['laundry_category_option']); ?>')">
                                </i>
                            </td>
                            <td>
                                <a href="javascript:void(0);" class="archive-btn" data-id="<?php echo $row['service_id']; ?>">
                                <i class='bx bxs-archive-in'></i>
                            </td>
                        </tr>
                    <?php
